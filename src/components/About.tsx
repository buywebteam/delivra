    ...
    <section className="bg-white pb-30 px-4 py-16 scroll-mt-20" id="about">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="mb-8 text-lg sm:text-xl">
          At Delivra, we’re revolutionizing logistics for businesses of all
        ...
        <div className="flex items-center justify-center">
          <div className="w-full md:w-2/3 text-center">
            ...
            <p className="text-lg sm:text-xl">
              At Delivra, we believe logistics should be effortless. Our mission
              is to simplify global transport by delivering reliable, on-time
              shipping solutions—ensuring every package, big or small, arrives
              safely and seamlessly at its destination
            </p>
          </div>
        </div>
      </div>
